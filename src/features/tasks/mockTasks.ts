...
export const DEMO_TASKS: GenerationTask[] = [
  {
    ...
    model: "Ptu1.0",
    aspectRatio: "1:1",
    templateId: "main_01", resolution: "2K", quality: "medium", variantCount: 1, liveImages: [],
    quantity: 1,
    sourceImages: [],
    modelImages: [],
    garmentImages: [],
    resultImages: [assetPath("demo/generated/mug-front.jpg")],
    status: "completed",
  ...
  },
  {
    ...
    mode: "text-to-image",
    imageType: "set",
    prompt: "陶瓷马克杯，防烫手柄，北欧简约风，奶油白色，适合家庭和办公使用",
    model: "Ptu1.0",
    aspectRatio: "1:1",
    templateId: "product_set_01", resolution: "2K", quality: "medium", variantCount: 1, liveImages: [],
    quantity: 1,
    sourceImages: [],
    modelImages: [],
    garmentImages: [],
    ...
    status: "generating",
    createdAt: "2026-07-15T13:04:52+08:00",
  },
  {
    id: "demo-mug-listing",
    mode: "text-to-image",
    ...
    model: "Ptu1.0",
    aspectRatio: "1:1",
    templateId: "listing_01", resolution: "2K", quality: "medium", variantCount: 1, liveImages: [],
    quantity: 1,
    sourceImages: [],
    modelImages: [],
    garmentImages: [],
  ...
  },
  {
    ...
    model: "Ptu1.0",
    aspectRatio: "1:1",
    templateId: "poster_01", resolution: "2K", quality: "medium", variantCount: 1, liveImages: [],
    quantity: 1,
    sourceImages: [],
    modelImages: [],
    garmentImages: [],
